package net.thegaminghuskymc.futopia.reference;
...
public class Refs {
    ...
    public static final String CLIENT_PROXY = "net.thegaminghuskymc.futopia.ClientProxy";
    public static final String COMMON_PROXY = "net.thegaminghuskymc.futopia.CommonProxy";

    public static final String COMPRESSOR_NAME = "compressor";
    public static final String PLATING_PRESS_NAME = "plating_press";
    public static final String REFINERY_NAME = "refinery";
    ...
    public static final String PARTICLE_BLOCKNAME = "particle_block";
    public static final String PROJECT_TABLENAME = "project_table";
    public static final String FOOD_FACTORY = "food_factory";

    public static final String KINETICGENERATOR_NAME = "kinetic_generator";
    public static final String WINDMILL_NAME = "windmill_controller";
