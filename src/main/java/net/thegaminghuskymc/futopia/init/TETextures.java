...
public class TETextures {
    ...
    private static final String BLOCKS_ = Refs.MODID + ":blocks/";
    ...
    private static final String CELL_ = BLOCKS_ + "storage1/cell_";
    private static final String CELL_CONFIG_ = BLOCKS_ + "config/cell_config_";
    private static final String TANK_ = BLOCKS_ + "storage1/tank_";
    private static final String CACHE_ = BLOCKS_ + "storage1/cache_";
    /* REFERENCES */
