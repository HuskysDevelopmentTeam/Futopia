...
public class IconHandler {
    ...
    public void preInit(){
        ...
        this.registerIcon("particle_sparkle", new ResourceLocation(Refs.MODID, "particle/sparkle"));
        this.registerIcon("gui_icon_info", new ResourceLocation(Refs.MODID, "gui/icons/info"));
    }
