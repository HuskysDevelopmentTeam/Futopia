package net.thegaminghuskymc.futopia.particle;
...
import net.thegaminghuskymc.futopia.util.helpers.VertexBufferHelper;
...
public class BaseParticle extends Particle {
    ...
    public static final ResourceLocation resourceLocation = new ResourceLocation(Refs.MODID + ":" + "textures/particles/" + setTexture(texture) + ".png");
