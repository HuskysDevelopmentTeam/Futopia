...
import net.thegaminghuskymc.futopia.block.BlockContainerBase;
import net.thegaminghuskymc.futopia.reference.Refs;
import net.thegaminghuskymc.futopia.tile.tier3.TileCPU;
...
public class BlockCPU extends BlockContainerBase {
    ...
    public BlockCPU() {
        ...
        setUnlocalizedName(Refs.BLOCKCPU_NAME);
    }
