...
import net.thegaminghuskymc.futopia.item.block.ItemBlockClearGlass;
...
public class BlockClearGlass extends BlockCore implements IDismantleable, IInitializer, IModelRegister {
