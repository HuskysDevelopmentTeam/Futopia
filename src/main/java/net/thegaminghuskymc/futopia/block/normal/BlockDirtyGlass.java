...
import net.thegaminghuskymc.futopia.item.block.ItemBlockDirtyGlass;
...
public class BlockDirtyGlass extends BlockCore implements IDismantleable, IInitializer, IModelRegister {

	public static final PropertyEnum<ClearGlassType> VARIANT = PropertyEnum.create("type", ClearGlassType.class);

	public BlockDirtyGlass() {

		super(Material.GLASS, Refs.MODID);

		setUnlocalizedName("dirty_glass");
	...
	public boolean preInit() {
		...
		setRegistryName("dirty_glass");
		GameRegistry.register(this);

		ItemBlockDirtyGlass itemBlock = new ItemBlockDirtyGlass(this);
		...
		OreDictionary.registerOre("blockDirtyGlass", new ItemStack(this, 1, OreDictionary.WILDCARD_VALUE));
