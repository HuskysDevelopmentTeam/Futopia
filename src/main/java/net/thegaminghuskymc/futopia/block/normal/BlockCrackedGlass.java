...
import net.thegaminghuskymc.futopia.item.block.ItemBlockCrackedGlass;
...
public class BlockCrackedGlass extends BlockCore implements IDismantleable, IInitializer, IModelRegister {
