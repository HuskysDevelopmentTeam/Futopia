...
import net.thegaminghuskymc.futopia.items.itemblocks.ItemBlockRefinery;
...
public class BlockRefinery extends Block implements ITileEntityProvider {
    ...
    public BlockRefinery() {
        ...
        setUnlocalizedName(BlockNames.REFINERY_NAME);
        setRegistryName(BlockNames.REFINERY_NAME);
