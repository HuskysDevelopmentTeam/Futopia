...
public class BlockXycroniumOre extends BlockFutopia implements IAnimationHandler {
    ...
    public void registerIcons(IIconRegister register) {
        ...
        for(int i = 0; i < this.getSubNames().length; i++){
            this.texture[i] = register.registerIcon(Refs.MODID + ":blocks/xycronium_ore/xycronium_ore_" + this.getSubNames()[i]);
        }
