...
public class BlockXycroniumStorage extends BlockFutopia implements IAnimationHandler {
    ...
    public void registerIcons(IIconRegister register) {
        this.texture = register.registerIcon(Refs.MODID + ":blocks/xycronium_block");
    }
